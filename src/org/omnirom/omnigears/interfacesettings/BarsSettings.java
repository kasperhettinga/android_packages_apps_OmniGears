...
public class BarsSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // TrafficStats should return -1 if the device does not support it. We should also have
        // some traffic to show by this point if this is truly working.
        if (TrafficStats.getTotalTxBytes() > 0 || TrafficStats.getTotalRxBytes() > 0) {
